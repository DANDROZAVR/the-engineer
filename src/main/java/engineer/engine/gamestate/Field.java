...
public class Field {
  ...
  //    public void setBuildingEnabled(boolean buildingEnabled){ this.buildingEnabled =
  // buildingEnabled; }
  //    public void setNumberOfMovesNeeded(int numberOfMovesNeeded){ this.numberOfMovesNeeded =
  // numberOfMovesNeeded; }
}
