...
//    BoardImpl board = new BoardImpl(factory, d1);
//
...
//    assertThrows(InvalidBoardDescriptionException.class, () -> new BoardImpl(factory, d2));
//  }
//
//  @Test
//  public void testGetField() {
//    BoardImpl board = new BoardImpl(new SampleFieldFactory(), new SampleDescription(4, 5));
//
...
//    BoardImpl board = new BoardImpl(new SampleFieldFactory(), new SampleDescription(5, 8));
//    BoardImpl.Observer observer = mock(BoardImpl.Observer.class);
//
